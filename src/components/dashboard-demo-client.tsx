...
import { TipsPanel } from "./dashboard/tips-panel";
import { SpendingByDayChart } from "./dashboard/spending-by-day-chart";
import { HighestTransactionCard } from "./dashboard/highest-transaction-card";
import { CategoryTransactionsDialog } from "./dashboard/dialogs/category-transactions-dialog";
import { DayTransactionsDialog } from "./dashboard/dialogs/day-transactions-dialog";
import { HighestDayCard } from "./dashboard/highest-day-card";
import { SpendingBySourceChart } from "./dashboard/spending-by-source-chart";
import { TopMerchantsChart } from "./dashboard/top-merchants-chart";
import { SourceTransactionsDialog } from "./dashboard/dialogs/source-transactions-dialog";
import { MerchantTransactionsDialog } from "./dashboard/dialogs/merchant-transactions-dialog";
import { TransactionDetailDialog } from "./dashboard/dialogs/transaction-detail-dialog";
import { BudgetingTab } from "./dashboard/budgeting-tab";
import { BudgetSpendingChart } from "./dashboard/budget-spending-chart";
import { AnomaliesCard } from "./dashboard/anomalies-card";
import { SpendingTrendChart } from "./dashboard/spending-trend-chart";
import { CurrentBalanceCard } from "./dashboard/current-balance-card";
...
import { AskAiCharacter } from "./dashboard/ask-ai-character";
...
export default function DashboardDemoClient() {
    const {
        transactionFiles,
        allTransactions,
        setAllTransactions,
    ...
    } = useTransactions(true, true); // Use 'true' for both pro and to load mock data
